package com.willfp.ItsMyMeta.integrations
...
import ru.oftendev.itsmymeta.meta.formatWithExtension
import ru.oftendev.itsmymeta.meta.getBalance

@Suppress("DEPRECATION")
class IntegrationVault(
    private val currency: MetaCurrency
) : Economy {
    ...
    @Deprecated(
        "Deprecated in Java", ReplaceWith(
            "EconomyResponse(0.0, 0.0, EconomyResponse.ResponseType.NOT_IMPLEMENTED, \"ItsMyMeta doesn't support bank accounts!\")",
    ...
    override fun createBank(name: String, player: String): EconomyResponse {
        return EconomyResponse(
            ...
            "ItsMyMeta doesn't support bank accounts!"
        )
    }
